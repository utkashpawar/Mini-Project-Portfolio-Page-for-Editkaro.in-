...
const PROJECTS = [
  ...
  { id:5,  cat:'gaming',        tag:'Gaming',        title:'Clutch Round Montage',      meta:'YouTube Shorts · 0:45',
    thumb:'Gemini_Generated_Image_jd9biejd9biejd9b.png', desc:'Kill-cam montage synced to beat drops with screen-shake accents and HUD overlays.', embedSrc:'https://youtube.com/embed/RzJ_Xn4xJrE?' },
  { id:6,  cat:'gaming',        tag:'Gaming',        title:'Season Recap Trailer',      meta:'YouTube · 2:10',
    thumb:'Gemini_Generated_Image_yi8xswyi8xswyi8x.png', desc:'Trailer-style recap edit with match highlights, motion graphics, and a custom title sequence.', embedSrc:'https://youtube.com/embed/KvS0MLj5IIE' },
  { id:7,  cat:'football',      tag:'Football Edits', title:'Derby Day Highlights',    meta:'Instagram · 0:52',
    thumb:'Gemini_Generated_Image_18z4vf18z4vf18z4.png', desc:'Match highlight reel with goal replays, slow-mo impact frames, and crowd-noise mix.', embedSrc:'https://youtube.com/embed/_GK1PdPnyWE' },
  { id:8,  cat:'football',      tag:'Football Edits', title:'Player Signing Hype',     meta:'TikTok · 0:28',
    thumb:'Gemini_Generated_Image_zehpiizehpiizehp.png', desc:'Announcement-style hype edit built to launch a new signing across club social channels.', embedSrc:'https://youtube.com/embed/QWobKDI5KIc' },
  { id:9,  cat:'ecommerce',     tag:'eCommerce Ads', title:'Unboxing → Add to Cart',   meta:'Meta Ads · 0:15',
    thumb:'Gemini_Generated_Image_71r7j971r7j971r7.png', desc:'Direct-response product ad optimized for a 15-second placement with an on-screen CTA.', embedSrc:' https://youtube.com/embed/yVI9cpCWsS0'},
  { id:10, cat:'ecommerce',     tag:'eCommerce Ads', title:'UGC Testimonial Cut',      meta:'Meta Ads · 0:22',
    thumb:'Gemini_Generated_Image_yinby8yinby8yinb.png', desc:'UGC-style testimonial edit with captions, product cutaways, and a performance-tested hook.', embedSrc:' https://youtube.com/embed/5wMoufYY1oM'},
  { id:11, cat:'documentary',   tag:'Documentary',   title:'The Last Workshop',        meta:'Short Doc · 6:30',
    thumb:'Gemini_Generated_Image_le63eole63eole63.png', desc:'Observational documentary edit with natural pacing, ambient sound design, and archival inserts.', embedSrc:null },
  { id:12, cat:'documentary',   tag:'Documentary',   title:'Voices of the Market',     meta:'Short Doc · 9:12',
   thumb:'Gemini_Generated_Image_czuh8sczuh8sczuh.png', desc:'Interview-driven documentary cut balancing talking heads with observational B-roll.', embedSrc:null },
