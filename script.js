...
const PROJECTS = [
  { id:1,  cat:'short-form',    tag:'Short-Form',    title:'Reel Hook — 0.8s Cut',     meta:'Instagram Reels · 0:24',
    thumb:'Gemini_Generated_Image_.png', desc:'Fast-paced vertical edit built for a sub-1-second scroll-stopping hook, cut to trending audio.', embedSrc:'https://youtube.com/embed/QD8zK_3MWmo'},
  { id:2,  cat:'short-form',    tag:'Short-Form',    title:'Behind the Counter',        meta:'TikTok · 0:31',
    thumb:'Gemini_Generated_Image_awypu0awypu0awyp.png', desc:'Day-in-the-life style short-form edit for a D2C food brand, captioned and platform-native.', embedSrc: 'https://www.youtube.com/embed/MoVlt-ptxIk' },
  { id:3,  cat:'long-form',     tag:'Long-Form',     title:'Founder Story — Ep. 03',    meta:'YouTube · 11:42',
   thumb:'Gemini_Generated_Image_s50mivs50mivs50m.png', desc:'Long-form narrative edit with multi-cam sync, lower-thirds, and pacing built for retention graphs.', embedSrc:'https://youtube.com/embed/ZK-rNEhJIDs' },
  { id:4,  cat:'long-form',     tag:'Long-Form',     title:'Studio Tour, Unfiltered',   meta:'YouTube · 18:05',
    thumb:'Gemini_Generated_Image_jrbuqcjrbuqcjrbu.png', desc:'Vlog-style long-form cut with A/B roll layering and a custom lower-third system.', embedSrc:'https://youtube.com/embed/mywcXtnVMY4' },
  { id:5,  cat:'gaming',        tag:'Gaming',        title:'Clutch Round Montage',      meta:'YouTube Shorts · 0:45',
    thumb:'Gemini_Generated_Image_jd9biejd9biejd9b.png', desc:'Kill-cam montage synced to beat drops with screen-shake accents and HUD overlays.', embedSrc:null },
  { id:6,  cat:'gaming',        tag:'Gaming',        title:'Season Recap Trailer',      meta:'YouTube · 2:10',
    thumb:'Gemini_Generated_Image_yi8xswyi8xswyi8x.png', desc:'Trailer-style recap edit with match highlights, motion graphics, and a custom title sequence.', embedSrc:null },
  { id:7,  cat:'football',      tag:'Football Edits', title:'Derby Day Highlights',    meta:'Instagram · 0:52',
    thumb:'Gemini_Generated_Image_18z4vf18z4vf18z4.png', desc:'Match highlight reel with goal replays, slow-mo impact frames, and crowd-noise mix.', embedSrc:null },
  { id:8,  cat:'football',      tag:'Football Edits', title:'Player Signing Hype',     meta:'TikTok · 0:28',
    thumb:'Gemini_Generated_Image_zehpiizehpiizehp.png', desc:'Announcement-style hype edit built to launch a new signing across club social channels.', embedSrc:null },
  { id:9,  cat:'ecommerce',     tag:'eCommerce Ads', title:'Unboxing → Add to Cart',   meta:'Meta Ads · 0:15',
    thumb:'Gemini_Generated_Image_71r7j971r7j971r7.png', desc:'Direct-response product ad optimized for a 15-second placement with an on-screen CTA.', embedSrc:null },
  { id:10, cat:'ecommerce',     tag:'eCommerce Ads', title:'UGC Testimonial Cut',      meta:'Meta Ads · 0:22',
    thumb:'Gemini_Generated_Image_yi8xswyi8xswyi8x.png', desc:'UGC-style testimonial edit with captions, product cutaways, and a performance-tested hook.', embedSrc:null },
  { id:11, cat:'documentary',   tag:'Documentary',   title:'The Last Workshop',        meta:'Short Doc · 6:30',
    thumb:'linear-gradient(160deg,#94a3b8,#1f2937)', desc:'Observational documentary edit with natural pacing, ambient sound design, and archival inserts.', embedSrc:null },
  { id:12, cat:'documentary',   tag:'Documentary',   title:'Voices of the Market',     meta:'Short Doc · 9:12',
   thumb:'linear-gradient(160deg,#cbd5e1,#334155)', desc:'Interview-driven documentary cut balancing talking heads with observational B-roll.', embedSrc:null },
  { id:13, cat:'color-grading', tag:'Color Grading', title:'Golden Hour Grade',        meta:'Grading Demo · 1:04',
    thumb:'linear-gradient(160deg,#ff5a36 0%,#2dd4bf 100%)', desc:'Split-tone grade pushing warm highlights against teal shadows for a cinematic look.', embedSrc:null },
  { id:14, cat:'color-grading', tag:'Color Grading', title:'Night Neon Grade',         meta:'Grading Demo · 0:48',
    thumb:'linear-gradient(160deg,#7c3aed 0%,#22d3ee 100%)', desc:'Moody neon grade built for a nightlife brand, matched across mixed lighting sources.', embedSrc:null },
  { id:15, cat:'anime',         tag:'Anime',         title:'AMV — Fall Arc',            meta:'YouTube · 3:20',
    thumb:'linear-gradient(160deg,#ec4899,#5b1436)', desc:'Beat-synced anime music video with motion-tracked effects and impact-frame timing.', embedSrc:null },
  { id:16, cat:'anime',         tag:'Anime',         title:'Character Reveal Edit',     meta:'TikTok · 0:19',
    thumb:'linear-gradient(160deg,#f472b6,#831843)', desc:'Reveal-style edit built around a single beat drop, formatted for fan-community reposting.', embedSrc:null },
  { id:17, cat:'ads',           tag:'Ads',            title:'App Launch Spot',          meta:'YouTube Ads · 0:30',
    thumb:'linear-gradient(160deg,#38bdf8,#0c4a6e)', desc:'Broadcast-style app launch spot with kinetic typography and a scored soundbed.', embedSrc:null },
  { id:18, cat:'ads',           tag:'Ads',            title:'Brand Anthem',             meta:'YouTube Ads · 1:00',
    thumb:'linear-gradient(160deg,#60a5fa,#1e3a8a)', desc:'Emotive brand anthem cut mixing scripted VO with real customer footage.', embedSrc:null },
];
