...
const PROJECTS = [
  ...
  { id:9,  cat:'ecommerce',     tag:'eCommerce Ads', title:'Unboxing → Add to Cart',   meta:'Meta Ads · 0:15',
    thumb:'linear-gradient(160deg,#facc15,#7c5c07)', desc:'Direct-response product ad optimized for a 15-second placement with an on-screen CTA.', embedSrc:null },
  { id:10, cat:'ecommerce',     tag:'eCommerce Ads', title:'UGC Testimonial Cut',      meta:'Meta Ads · 0:22',
    thumb:'linear-gradient(160deg,#fde047,#8a6d0a)', desc:'UGC-style testimonial edit with captions, product cutaways, and a performance-tested hook.', embedSrc:null },
