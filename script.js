...
const PROJECTS = [
  { id:1,  cat:'short-form',    tag:'Short-Form',    title:'Reel Hook — 0.8s Cut',     meta:'Instagram Reels · 0:24',
    thumb:'reel-hook.jpg', desc:'Fast-paced vertical edit built for a sub-1-second scroll-stopping hook, cut to trending audio.', embedSrc:'https://youtube.com/embed/FZEi_T8_MnI'},
  ...
  { id:4,  cat:'long-form',     tag:'Long-Form',     title:'Studio Tour, Unfiltered',   meta:'YouTube · 18:05',
    gradient:'linear-gradient(160deg,#3ee4c8,#136b60)', desc:'Vlog-style long-form cut with A/B roll layering and a custom lower-third system.', embedSrc:'https://youtube.com/embed/3p336B0wDJs' },
