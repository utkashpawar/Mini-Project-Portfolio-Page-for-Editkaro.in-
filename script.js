...
const PROJECTS = [
  { id:1,  cat:'short-form',    tag:'Short-Form',    title:'Reel Hook — 0.8s Cut',     meta:'Instagram Reels · 0:24',
    thumb:'reel-hook.jpg', desc:'Fast-paced vertical edit built for a sub-1-second scroll-stopping hook, cut to trending audio.', embedSrc:'https://www.youtube.com/embed/Te-lLYd6QyY'},
  { id:2,  cat:'short-form',    tag:'Short-Form',    title:'Behind the Counter',        meta:'TikTok · 0:31',
    thumb:'legend-wallpaper.jpg', desc:'Day-in-the-life style short-form edit for a D2C food brand, captioned and platform-native.', embedSrc: 'https://www.youtube.com/embed/7uXZG0pTxME?si=eZy1CkkkM60-9cOD' },
