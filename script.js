...
const PROJECTS = [
  { id:1,  cat:'short-form',    tag:'Short-Form',    title:'Reel Hook — 0.8s Cut',     meta:'Instagram Reels · 0:24',
    thumb:'https://share.gemini.google/F6mqgYxyle5F', desc:'Fast-paced vertical edit built for a sub-1-second scroll-stopping hook, cut to trending audio.', embedSrc:'https://youtube.com/embed/FZEi_T8_MnI'},
